...
public class RevenueFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_revenue, container, false);
        anhxa(view);
        setRecyclerView();
        GetDataCV();
        eventFab();
...
//                        imgCVbyte = ParseByteArr.imgCvbyte;
                        if (TextUtils.isEmpty(nameJob) || TextUtils.isEmpty(money) || TextUtils.isEmpty(date) || imgCVbyte == null) {
                            ...
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    MainActivity.database.QueryData("UPDATE DoanhThu SET id = '" + id + "', nameCV = '" + nameJob + "', money = '" + money + "', donviThu = '" + donviThu + "', danhGia = 0,deleteFlag = 0,date = '" + date + "', ghiChu = '" + note + "', idLoai = '" + idLoai + "',idUser = '" + UserID + "' WHERE id = '" + id + "' AND idUser = '" + UserID + "'");
            ...
            public void onClickDeleteCv(final int i, final Thu_Chi_Model model) {
                ...
                alertDialog.setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        MainActivity.database.QueryData("UPDATE DoanhThu SET deleteFlag = 1 WHERE id = '" + model.getId() + "' AND idUser = '" + model.getIdUser() + "'");
            ...
            public void onClickItemCv(final int i, final Thu_Chi_Model model) {
                ...
                // gán dữ liệu
                txtTitle.setText("Chi tiết Doanh thu");
                txttenCvdialogDetail.setText(model.getNameCV());
                //format money
                txtmoneyCvdialogDetail.setTextColor(Color.BLUE);
                ...
                Cursor cursor = MainActivity.database.GetData("SELECT LoaiThu.tenloai FROM LoaiThu INNER JOIN DoanhThu WHERE '"+idLoai+"' = LoaiThu.id");
        ...
        buttonAddCv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(nameJob) || TextUtils.isEmpty(money) || TextUtils.isEmpty(date) || imgCVbyte == null) {
                    ...
                    MainActivity.database.INSERT_Cv("DoanhThu", nameJob, b, donviThu, 0, 0, date, note, imgCVbyte, idLoai, UserID);
    ...
    private void dialogAddLoai() {
        ...
        btnAddLoai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MainActivity.database.INSERT_Loai("LoaiThu", loaiNew, 0, imgIconbyte, UserID);
    ...
    private void GetDataLoaiThu() {
        Cursor dataLoai = MainActivity.database.GetData("SELECT * FROM LoaiThu WHERE iduser = '" + UserID + "' AND deleteflag = 0 ");
